    ...
    <div className="bg-[#050505] min-h-screen pt-32 pb-24">
      ...
      <div className="max-w-4xl mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-16">
          {skills.map((s) => (
            <div key={s.title} className="glass-card p-6 rounded-xl border border-white/5 bg-white/2">
        ...
        <div className="grid grid-cols-3 gap-4 mb-16">
          {[
            ...
            <div key={stat.label} className="glass-card p-6 rounded-xl border border-white/5 text-center">
